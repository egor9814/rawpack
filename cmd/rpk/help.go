...
func help() {
	...
	fmt.Println("zstd_memory_limit: {digit}+[GMKB%]")
	fmt.Println("  in creating archive means window size (default: 70%)")
	fmt.Println("  in reading archive means memory limit (default: 8G)")
	fmt.Println()
